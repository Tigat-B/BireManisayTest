...
<%=checkPermission(out,"diagnoses.populationdiagnoses","edit",activeUser)%>
<%=sJSSORTTABLE%>
        ...
        <tr>
            ...
            <td class="admin2">
                <select class="text" name="FindEncounterOutcome" style="vertical-align:-2px;">
                    <option value="">
                    <%=ScreenHelper.writeSelectUnsorted(request,SH.cs("encounterOutcomeType","encounter.outcome"),checkString(sFindEncounterOutcome),sWebLanguage)%>
                </select>
            </td>
        </tr>
