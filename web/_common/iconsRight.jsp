    	...
    	menuElem = getMenuElement(session,sLongLabelId);
       	...
       	if(menuElem!=null){
            ...
            // continue checking requirements
       		...
       		if(okToDisplayIcon){
           		// check wether patient is selected when the xml-menu-item demands it
	       		String sPatientActiveEncounter = checkString(menuElem.attributeValue("activeencounter"));
           		//Debug.println("sPatientSelectedRequired : "+sPatientSelectedRequired); 
           		
		        if(sPatientActiveEncounter.equalsIgnoreCase("true")){
		        	boolean activeEncounter = Encounter.getActiveEncounter(activePatient.personid)!=null;
	           		//Debug.println("patientSelected : "+patientSelected);
	                okToDisplayIcon = activeEncounter;
	            }
       		}
