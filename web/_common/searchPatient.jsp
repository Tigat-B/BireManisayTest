...
<%
    ...
    // fedault focus
    if(activeUser==null){
    	SH.syslog("!!! activeUser=null in searchPatient.jsp called from "+request.getRemoteHost());
    }
    String sDefaultFocus = activeUser==null?"":checkString(activeUser.getParameter("DefaultFocus"));
