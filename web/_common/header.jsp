						   	    ...
						   	    if(bgi.length() > 0){
					   	    	    ...
					   	    	    <center>
							            ...
							            <div style='vertical-align: bottom; padding-bottom: 5px; padding-right: 10px'>
						   	    	    	...
						   	    	    	<span style='white-space: nowrap;font-size: 9px'><%=sVersion %></span><%=SH.ci("enableTemperatureMonitoring",0)==1?"<br/>CPU: <span id='temperature' style='color:red; font-weight: bolder'></span>":""%>
