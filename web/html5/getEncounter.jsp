		...
		<form name='transactionForm' method='post'>
			...
			<table width='100%'>
				...
				<tr>
					...
					<td class='mobileadmin2' style='font-size:6vw;font-weight: bold'><%=getTranNoLink(SH.cs("encounterOrigin","urgency.origin"),encounter.getOrigin(),sWebLanguage)%></td>
				</tr>
				<tr>
					<td class='mobileadmin2' style='font-size:6vw'><%=getTranNoLink("web","situation",sWebLanguage) %></td>
					<td class='mobileadmin2' style='font-size:6vw;font-weight: bold'><%=getTranNoLink(SH.cs("encounterSituation","encounter.situation"),encounter.getSituation(),sWebLanguage)%></td>
				</tr>
			<%
