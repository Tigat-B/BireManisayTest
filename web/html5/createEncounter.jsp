				...
				<tr>
					...
					<td class='mobileadmin2' style='font-size:6vw;font-weight: bold'>
		                <select name="origin" id="origin" style='max-width: 160px;font-size:6vw'>
		                    <option/>
		                    <%=ScreenHelper.writeSelect(request,SH.cs("encounterOrigin","urgency.origin"),"",sWebLanguage)%>
		                </select>
					</td>
				</tr>
				<tr>
					...
					<td class='mobileadmin2' style='font-size:6vw;font-weight: bold'>
		                <select name="situation" id="situation" style='max-width: 160px;font-size:6vw'>
		                    <option/>
		                    <%=ScreenHelper.writeSelect(request,SH.cs("encounterSituation","encounter.situation"),"",sWebLanguage)%>
		                </select>
					</td>
				</tr>
			</table>
