...
<table width="100%" cellspacing="1" class="menu" onkeydown="if(enterEvent(event,13)){doFind();}">
    ...
    <tr>
      ...
      <td class="admin2" id="FindLabelTypeDiv" width='100px'>
          <select id="FindLabelType" class="text">
              ...
              <%
                  ...
                  while(iter.hasNext()){
                      ...
                      if(sTmpLabeltype.length()>70){
                    	  sTmpLabeltype=sTmpLabeltype.substring(0,70);
                      }
...
<table class="list" width="100%" cellspacing="1">
  ...
  <tr>
      ...
      <td class="admin2">
          <input type="text" class="normal" name="EditLabelType" id="EditLabelType" value="<%=editLabelType.length()>0?editLabelType:findLabelType%>" size="60">
      </td>
  </tr>
  ...
  <tr>
      <td class="admin"><%=getTran(null,"Web.Translations","LabelID",sWebLanguage)%></td>
      <td class="admin2">
          <input type="text" class="normal" name="EditLabelID" id="EditLabelID" value="<%=editLabelID%>" size="60">
      </td>
  </tr>
		  ...
		  <tr>
		      ...
		      <td class="admin2">
		          ...
		          <input readonly type="text" class="text" name="remLen<%=tmpLang.toUpperCase()%>" size="3" value="5000">
		           ...
		           <% if(!tmpLang.equalsIgnoreCase(SH.cs("baseTranslationLanguage",sWebLanguage))){ %>
...
<script>
 ...
 <%-- CLEAR EDIT FIELDS --%>
  ...
  function dotranslate(targetlanguage){
      var today = new Date();
      var url= '<c:url value="/system/getTranslation.jsp"/>?sourcelanguage=<%=SH.cs("baseTranslationLanguage",sWebLanguage)%>&targetlanguage='+targetlanguage+'&labelvalue='+document.getElementById('EditLabelValue<%=SH.cs("baseTranslationLanguage",sWebLanguage).toUpperCase()%>').value+'&ts='+today;
      new Ajax.Request(url,{
          method: "POST",
          postBody: "",
          onSuccess: function(resp){
