...
<%
    ...
    String sFindInsurarId       = checkString(request.getParameter("FindInsurarId")),
    	   ...
    	   sEditInsurarOpenIMISEnabled  = checkString(request.getParameter("EditInsurarOpenIMISEnabled")),
    	   sEditInsurarOpenIMISURL  = checkString(request.getParameter("EditInsurarOpenIMISURL")),
    	   sEditInsurarOpenIMISUserName  = checkString(request.getParameter("EditInsurarOpenIMISUserName")),
    	   sEditInsurarOpenIMISPassword  = checkString(request.getParameter("EditInsurarOpenIMISPassword")),
    ...
    if(sAction.equals("save")){
        ...
        insurar.setOpenIMIS_Enabled(sEditInsurarOpenIMISEnabled);
        insurar.setOpenIMIS_URL(sEditInsurarOpenIMISURL);
        insurar.setOpenIMIS_UserName(sEditInsurarOpenIMISUserName);
        insurar.setOpenIMIS_Password(sEditInsurarOpenIMISPassword);
        ...
        //--- SHOW ONE INSURAR IN DETAIL ----------------------------------------------------------
            ...
            %>
                ...
                <table width="100%" cellspacing="1" cellpadding="0" class="list">
                    ...
                    <tr>
                        <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran(request,"web","openimis.enabled",sWebLanguage)%></td>
                        <td class="admin2">
                            <input type="radio" id='openIMISDisabled' class="text" name="EditInsurarOpenIMISEnabled" value="0" <%=insurar.isOpenIMISConfigured()?"":"checked" %> onchange="checkOpenIMIS()"/><%=getTran(request,"web","no",sWebLanguage) %>
                            <input type="radio" id='openIMISEnabled' class="text" name="EditInsurarOpenIMISEnabled" value="1" <%=insurar.isOpenIMISConfigured()?"checked":"" %> onchange="checkOpenIMIS()"/><%=getTran(request,"web","yes",sWebLanguage) %>
                        </td>
                    </tr>
                    <tr id='openimis.url'>
                        <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran(request,"web","openimis.url",sWebLanguage)%></td>
                        <td class="admin2">
                            <input autocomplete="off" type="text" class="text" name="EditInsurarOpenIMISURL" size="100" value="<%=insurar.getOpenIMIS_URL()%>"/>
                        </td>
                    </tr>
                    <tr id='openimis.username'>
                        <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran(request,"web","openimis.username",sWebLanguage)%></td>
                        <td class="admin2">
                            <input autocomplete="off" type="text" class="text" name="EditInsurarOpenIMISUserName" size="40" value="<%=insurar.getOpenIMIS_UserName()%>"/>
                        </td>
                    </tr>
                    <tr id='openimis.password'>
                        <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran(request,"web","openimis.password",sWebLanguage)%></td>
                        <td class="admin2">
                            <input autocomplete="off" type="password" class="text" name="EditInsurarOpenIMISPassword" size="40" value="<%=insurar.getOpenIMIS_Password()%>"/>
                        </td>
                    </tr>
...
<script>
  ...
  function checkOpenIMIS(){
	  if(document.getElementById("openIMISEnabled").checked){
		  document.getElementById("openimis.url").style.display='';
		  document.getElementById("openimis.username").style.display='';
		  document.getElementById("openimis.password").style.display='';
	  }
	  else{
		  document.getElementById("openimis.url").style.display='none';
		  document.getElementById("openimis.username").style.display='none';
		  document.getElementById("openimis.password").style.display='none';
	  }
  }
