...
<table border="0" width="100%" class="list" cellspacing="1">
  ...
  <%-- LIMITED VISIBILITY --%>
  <tr>
    <td class="admin"><%=getTran(request,"lab","limitedvisibility",sWebLanguage)%></td>
    <td class="admin2">
  ...
  <script>
  	function setEditorParameters(){
  		...
  		var parameters="<%=sEditorParameters%>";
			...
			"<td class='admin2'>"+
			"<textarea name='EPOptions' id='EPOptions' class='text' cols='50'>"+getParameter(parameters,"OP")+"</textarea>"+
			"</td></tr>";
	  	}
