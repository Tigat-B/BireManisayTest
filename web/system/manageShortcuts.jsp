		...
		<tr>
		    ...
		    <td class='admin2'>
	            <select class="text" name="FastEncounterOrigin.1">
	                <option/>
	                <%=ScreenHelper.writeSelect(request,SH.cs("encounterOrigin","urgency.origin"),fastencounter.split(";").length>1?fastencounter.split(";")[1]:"",sWebLanguage)%>
	            </select>
			</td>
	        <td class='admin2'>
		    ...
		    <td class='admin2'>
	            <select class="text" name="FastEncounterSituation.1">
	                <option/>
	                <%=ScreenHelper.writeSelect(request,SH.cs("encounterSituation","encounter.situation"),fastencounter.split(";").length>4?fastencounter.split(";")[4]:"",sWebLanguage)%>
	            </select>
			</td>
		</tr>
		...
		<tr>
		    ...
		    <td class='admin2'>
	            <select class="text" name="FastEncounterOrigin.3">
	                <option/>
	                <%
	                    out.print(ScreenHelper.writeSelect(request,SH.cs("encounterOrigin","urgency.origin"),fastencounter.split(";").length>1?fastencounter.split(";")[1]:"",sWebLanguage));
	                %>
	            </select>
			</td>
	        <td class='admin2'>
