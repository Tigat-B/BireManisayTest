        ...
        <tr>
            <td>
                <%
                    ...
                    hMenu.put(getTran(request,"web","manageDeviceMappings",sWebLanguage),"main.do?Page=util/manageDeviceMappings.jsp");
    ...
    <table width="100%" cellspacing="2" cellpadding="0">
        <tr>
            <td>
                <% 
                    hMenu = new Hashtable();
	                hMenu.put(getTran(request,"web.manage","loadopenimisservices",sWebLanguage),"main.do?Page=util/loadOpenIMISItems.jsp");
                    out.print(ScreenHelper.writeTblHeader(getTran(request,"web.manage","openimis",sWebLanguage),sCONTEXTPATH)+
                    		  sortMenu(hMenu)+
                    		  ScreenHelper.writeTblFooter());
                %>
            </td>
