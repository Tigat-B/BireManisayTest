                ...
                <table width="100%" cellspacing="1" cellpadding="0" class="list">
                    ...
                    <tr>
                   	...
                   	<% if(MedwanQuery.getInstance().getConfigInt("enableCCBRT",0)==1 || MedwanQuery.getInstance().getConfigInt("automatedDebet",0)==1){ %>
	                    <tr>
	                        ...
	                        <td class="admin2">
                            	<input type="text" class="text" name="EditPrestationCodeAlias" size="80" value="<%=prestation.getReferenceObject()==null?"":checkString(prestation.getReferenceObject().getObjectUid())%>">
	                       </td>
	                   </tr>
                    <%} %>
                    <tr>
                    ...
                    <tr>
                   	...
                   	<%
                   		...
                   		else if(MedwanQuery.getInstance().getConfigInt("enableQuickSoft",0)==1){
                  	%>
                        <td class="admin"><%=getTran(request,"web","accountingcode",sWebLanguage)%></td>
                        <td class="admin2">
                           	<input type="text" class="text" name="EditPrestationInvoiceGroup" size="10" maxlength="50" value="<%=prestation.getInvoiceGroup()==null?"":prestation.getInvoiceGroup()%>" onblur='if(!this.value=="" && !this.value.startsWith("7")){this.value="";alert("<%=getTranNoLink("web","valueoutofrange",sWebLanguage)+": 7..."%>");this.focus();}'>
                        </td>
                  	<%
                   		}
                   		else {
