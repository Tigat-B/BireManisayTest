                            ...
                            if (rs.next()) {
                                ...
                                if (rs.next()) {
            	                	...
            	                	if(SH.ci("GDPREnabled", 0)==1) {
            	                		ps = destination.prepareStatement("insert into Healthrecorddata(healthRecordId,dateBegin,dateEnd,personId,serverid,version,versionserverid) values(aes_encrypt(?,'ABCD1234'),?,null,?,?,1,?)");
            	                	}
            	                	else{
