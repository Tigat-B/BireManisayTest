...
<table class="list" width="100%" cellspacing="1" cellpadding="0">
    ...
    <tbody id="invoicedetails" style="visibility:hidden">
            		...
            		<tr>
            			<td>
            				<table width='100%'>
		            			...
		            			<tr>
            						<td>
		            					Patient Invoice <input type="text" class="text" name="EditInvoiceAdd" id="EditInvoiceAdd" value="">
		            					<img src="/openclinic/_img/icons/icon_add.gif" class="link" alt="Ajouter" onclick="addInvoiceToSelection();">
		            					<img src="/openclinic/_img/icons/icon_delete.png" class="link" alt="Vider" onclick="document.getElementById('EditInvoiceAdd').value='';">
		            				</td>
		            			</tr>
		            			<!--HMK END-->
		            		</table>
        ...
        <tr>
            ...
            <td class="admin2">
                <div id="divPrestations" name="divPrestations"  class="searchResults" style="height:120px;width:100%"></div>
...
<script>
   // ------ HMK --------
  function addInvoiceToSelection(){
	var content = $("divPrestations").firstElementChild;
	//var numb = content.firstElementChild.childElementCount;
	var numb = content.firstElementChild.childElementCount;
	var found_row = 0;
	  for (var i = 2; i < numb; i++) {
		var siglerow = content.firstElementChild.childNodes[i];

		if(siglerow.childNodes[3]!=='undefined'){
			
		if(siglerow.childNodes[3].textContent==$('EditInvoiceAdd').value){
    	 
			doBalance(siglerow.childNodes[0].firstElementChild,true);
          }
		}else{
			//alert(siglerow.childNodes[3]);
		}
	   }
    }
    //------ HMK --------
