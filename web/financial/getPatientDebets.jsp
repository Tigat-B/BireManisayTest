                ...
                if(sDebetUID!=null && sDebetUID.length()>0){
                    ...
                    if(debet!=null){
                        ...
                        sReturn.append( "<tr class='list"+sClass+"'>"
	                            ...
	                            +"<td nowrap>"+patientAmount+" "+MedwanQuery.getInstance().getConfigParam("currency","€")+"</td>"
	                            +"<td>"+sCredited+"&nbsp;</td>"
	                            +"<td style='text-align: center'>"+(debet.getInsurarInvoiceUid()==null?"":ScreenHelper.checkString(debet.getInsurarInvoiceUid()).replaceAll("1\\.",""))+"&nbsp;</td>"
	                            +"<td style='text-align: center'>"+(debet.getExtraInsurarInvoiceUid()==null?"":ScreenHelper.checkString(debet.getExtraInsurarInvoiceUid()).replaceAll("1\\.",""))+"&nbsp;</td>"
	                            +"<td style='text-align: center'>"+(debet.getExtraInsurarInvoiceUid2()==null?"":ScreenHelper.checkString(debet.getExtraInsurarInvoiceUid2()).replaceAll("1\\.",""))+"</td>"
	                        +"</tr>");
                    }
                }
            }
...
<table width="100%" cellspacing="1" cellpadding="0">
    ...
    <tr class="gray">
        ...
        <td style='text-align: center'><%=getTranNoLink("web","insuranceinvoiceid",sWebLanguage)%></td>
        <td style='text-align: center'><%=getTranNoLink("web","extrainsuranceinvoiceid",sWebLanguage)%></td>
        <td style='text-align: center'><%=getTranNoLink("web","extrainsuranceinvoiceid2",sWebLanguage)%></td>
    </tr>
