...
<table width="100%" class="list" border="0">
    ...
    <tr>
        ...
        <td class="admin2"><b><%=(encounter.getService()==null?"":encounter.getService().getLabel(sWebLanguage))+(encounter.getOutcome()==null?"":" ("+getTran(request,SH.cs("encounterOutcomeType","encounter.outcome"),encounter.getOutcome(),sWebLanguage)+")")%>
        </b></td>
    </tr>
    <%
            }
