...
%>
 ...
 %>
    <tr >
        <%-- examination name --%>
        <td>
            <img src="<c:url value="/_img/pijl.gif"/>"><button accesskey="<%=counter%>" class="buttoninvisible" onclick="window.location.href='<c:url value='/main.do'/>?Page=healthrecord/globalReferenceEdit.jsp&ts=<%=getTs()%>'"></button><u><%=counter++%></u> <%=getTran(request,"web","internal_references",sWebLanguage)%>
        </td>
        <%-- create --%>
        <td align="center">
    ...
    <tr >
        <%-- examination name --%>
        <td>
            <img src="<c:url value="/_img/pijl.gif"/>"><button accesskey="<%=counter%>" class="buttoninvisible" onclick="window.location.href='<c:url value='/main.do'/>?Page=healthrecord/globalReferenceSummary.jsp&ts=<%=getTs()%>'"></button><u><%=counter++%></u> <a href="<c:url value='/main.do'/>?Page=healthrecord/globalReferenceSummary.jsp&ts=<%=getTs()%>"><%=getTran(request,"web","internal_references_summary",sWebLanguage)%></a>
        </td>
        <td/><td/><td/><td/>
    </tr>
    <%
    ...
    <tr >
        <%-- examination name --%>
        <td>
            <img src="<c:url value="/_img/pijl.gif"/>"><button accesskey="<%=counter%>" class="buttoninvisible" onclick="window.location.href='<c:url value='/main.do'/>?Page=healthrecord/globalReferenceSummary.jsp&ts=<%=getTs()%>'"></button><u><%=counter++%></u> <a href="javascript:openPopup('medical/manageCarePrescriptionsPopup.jsp',700,400);"><%=getTran(request,"web","careprescriptions",sWebLanguage)%></a>
        </td>
        <td/><td/><td/><td/>
    </tr>
    <%
    ...
    <tr >
        <%-- examination name --%>
        <td>
            <img src="<c:url value="/_img/pijl.gif"/>"><button accesskey="<%=counter%>" class="buttoninvisible" onclick="window.location.href='<c:url value='/main.do'/>?Page=healthrecord/globalReferenceSummary.jsp&ts=<%=getTs()%>'"></button><u><%=counter++%></u> <a href="javascript:openPopup('medical/managePrescriptionsPopup.jsp',700,400);"><%=getTran(request,"web","medications",sWebLanguage)%></a>
        </td>
        <td/><td/><td/><td/>
    </tr>
    <%
    ...
    <%-- PAGE TITLE --%>
    <tr class="admin">
        <td>&nbsp;<%=getTran(request,"web","specificexaminations2",sWebLanguage)%> (<%=getTran(request,"Service",activeUser.activeService.code,sWebLanguage)%>)</td>
        <td/>
        <td align="center"><%=getTran(request,"web","lastexamination",sWebLanguage)%></td>
        <td align="center"><%=getTran(request,"web","planned",sWebLanguage)%></td>
        <td/>
    </tr>
    <%-- DYNAMIC LINKS --------------------------------------------------------------------------%>
    <%
    ...
    <tr id="otherServicesHeader" onClick="toggleOtherServices();" onmouseover="this.style.cursor='hand';" onmouseout="this.style.cursor='default';" height="15">
        <td colspan="5">
            <img src="<c:url value="/_img/pijl.gif"/>"><a href="#"><b>&nbsp;<%=getTran(request,"Web.manage","examinationsofotherservices",sWebLanguage)%></b></a>
        </td>
    </tr>
<%
    }
                ...
                %>
                    ...
                    <tr class="list<%=sClass%>" id="otherServiceHeader_<%=serviceId%>" title="<%=showExamsTran%>" onclick="hideAllServiceExaminations('<%=serviceId%>');toggleServiceRow('<%=serviceId%>');" onmouseover='this.style.cursor="hand"' onmouseout='this.style.cursor="default"'>
                        ...
                        <td colspan="4">
                            ...
                            <%=getTran(request,"Web","service",sWebLanguage)%> <%=getTran(request,"service",serviceId,sWebLanguage)%>
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            <%-- sub-header --%>
                                <tr class="admin">
                                    <td width="400"><%=getTran(request,"web","examination",sWebLanguage)%></td>
                                    <td width="100"/>
                                    <td align="center" width="100"><%=getTran(request,"web","lastexamination",sWebLanguage)%></td>
                                    <td align="center" width="100"><%=getTran(request,"web","planned",sWebLanguage)%></td>
                                    <td/>
