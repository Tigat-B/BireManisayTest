...
function changeSector(){
    ...
    <%
        ...
        out.print(sBeginDate
              ...
              +"<input type='hidden' name='PCell' id='PCell'/><input type='hidden' name='HSRegion' id='HSRegion'/><input type='hidden' name='HSDistrict' id='HSDistrict'/><input type='hidden' name='HSPost' id='HSPost'/><input type='hidden' name='HSVillage' id='HSVillage'/>"
           	  /**
