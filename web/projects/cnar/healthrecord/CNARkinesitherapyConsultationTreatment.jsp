...
<form id="transactionForm" name="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>' onclick="setSaveButton(event);" onkeyup="setSaveButton(event);">
    ...
    <table class="list" cellspacing="1" cellpadding="0" width="100%">
        ...
        <%-- ICPC / ICD10 --%>
        <tr>
            <td class="admin"><a href="javascript:openPopup('healthrecord/findICPC.jsp&ts=<%=getTs()%>&patientuid=<%=activePatient.personid %>')"><%=getTran(request,"openclinic.chuk","diagnostic",sWebLanguage)%> <%=getTran(request,"Web.Occup","ICPC-2",sWebLanguage)%>/<%=getTran(request,"Web.Occup","ICD-10",sWebLanguage)%></a></td>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web","kine.manager",sWebLanguage)%></td>
            <td class="admin2">
                <select class='text' name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNAR_CONSULTATION_KINE" property="itemId"/>]>.value">
                    <option/>
                    <%
                        out.print(ScreenHelper.writeSelect(request,"encounter.kine.manager",tran.getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNAR_CONSULTATION_KINE"),sWebLanguage));
                    %>
                </select>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <script type="text/javascript">writeMyDate("startdate","<c:url value="/_img/icons/icon_agenda.png"/>","<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
            </td>
        </tr>
            ...
            <td class="admin2">
                <table class="list" cellspacing="1" cellpadding="0" width="100%" id="tblSeances">
                    ...
                    <tr>
                        ...
                        <td class="admin" width="140"><%=getTran(request,"Web.occup","medwan.common.date",sWebLanguage)%></td>
                        <td class="admin" width="70"><%=getTran(request,"Web.occup","medwan.common.hour",sWebLanguage)%></td>
                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            ...
                            <script type="text/javascript">writeMyDate("seanceDate","<c:url value="/_img/icons/icon_agenda.png"/>","<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
                        </td>
                        <td class="admin2">
                        ...
                        <%-- ADD/EDIT BUTTONS --%>
                        <td class="admin2">
                            <input type="button" class="button" name="ButtonAddSeance" value="<%=getTran(null,"Web","add",sWebLanguage)%>" onclick="addSeance();">
                            <input type="button" class="button" name="ButtonUpdateSeance" value="<%=getTran(null,"Web","edit",sWebLanguage)%>" onclick="updateSeance();">
                        </td>
                    </tr>
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <script type="text/javascript">writeMyDate("enddate","<c:url value="/_img/icons/icon_agenda.png"/>","<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
            </td>
        </tr>
...
function addSeance(){
  if(isAtLeastOneSeanceFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteSeance(rowSeance"+iSeancesIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSeance(rowSeance"+iSeancesIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateSeance(){
  if(isAtLeastOneSeanceFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSeance("+editSeancesRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSeance("+editSeancesRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
