...
<form id="transactionForm" name="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>' onclick="setSaveButton(event);" onkeyup="setSaveButton(event);">
    ...
    <%
        ...
        String sTranNewGlassesRightDistantVisionSpherical = "";
        String sTranNewGlassesRightDistantVisionCylindrical = "";
        String sTranNewGlassesRightDistantVisionAxis = "";
        String sTranNewGlassesLeftDistantVisionSpherical = "";
        String sTranNewGlassesLeftDistantVisionCylindrical = "";
        String sTranNewGlassesLeftDistantVisionAxis = "";
        String sTranNewGlassesRightNearVisionSpherical = "";
        String sTranNewGlassesRightNearVisionCylindrical = "";
        String sTranNewGlassesRightNearVisionAxis = "";
        String sTranNewGlassesLeftNearVisionSpherical = "";
        String sTranNewGlassesLeftNearVisionCylindrical = "";
        String sTranNewGlassesLeftNearVisionAxis = "";

        String sTranNewGlassesDistantIP="";
        String sTranNewGlassesNearIP="";
        ...
        if (transaction != null){
            ...
            if (tran!=null){
                ...
                sTranNewGlassesRightDistantVisionSpherical = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_SPHERICAL");
                sTranNewGlassesRightDistantVisionCylindrical = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_CYLINDRICAL");
                sTranNewGlassesRightDistantVisionAxis = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_AXIS");
                sTranNewGlassesLeftDistantVisionSpherical = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_SPHERICAL");
                sTranNewGlassesLeftDistantVisionCylindrical = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_CYLINDRICAL");
                sTranNewGlassesLeftDistantVisionAxis = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_AXIS");
                sTranNewGlassesRightNearVisionSpherical = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_SPHERICAL");
                sTranNewGlassesRightNearVisionCylindrical = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_CYLINDRICAL");
                sTranNewGlassesRightNearVisionAxis = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_AXIS");
                sTranNewGlassesLeftNearVisionSpherical = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_SPHERICAL");
                sTranNewGlassesLeftNearVisionCylindrical = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_CYLINDRICAL");
                sTranNewGlassesLeftNearVisionAxis = getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_AXIS");

                sTranNewGlassesDistantIP=getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_DISTANT_IP");
                sTranNewGlassesNearIP=getItemType(tran.getItems(),sPREFIX+"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_NEAR_IP");
    ...
    <table class="list" cellspacing="1" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <td class="admin2" colspan="4">
                ...
                <script type="text/javascript">writeMyDate("trandate","<c:url value="/_img/icons/icon_agenda.png"/>","<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
            </td>
        </tr>
		<tr>
        ...
        <tr>
            ...
            <td class="admin" width="150" rowspan="2"><%=getTran(request,"openclinic.chuk","without.correction",sWebLanguage)%></td>
            <td class="admin" width="50"><%=getTran(request,"openclinic.chuk","od",sWebLanguage)%></td>
            <td class="admin2">
                <input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CURRENT_GLASSES_OD")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CURRENT_GLASSES_OD" property="itemId"/>]>.value" value="<%=sTranCurrentGlasses_OD%>" size="8" />&nbsp;
            </td>
            <td class="admin2">
                D <img src="<c:url value="/_img/up_down_arrow.gif"/>" alt=""/> &nbsp;<input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CURRENT_GLASSES_OD_D")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CURRENT_GLASSES_OD_D" property="itemId"/>]>.value" value="<%=sTranCurrentGlasses_OD_D%>" size="8"/>&nbsp;
            </td>
            <td colspan="2" rowspan="2" class="admin2">
                <%=getTran(request,"web","comment",sWebLanguage)%>&nbsp;<textarea cols="80" onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CURRENT_GLASSES_ADD")%> class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CURRENT_GLASSES_ADD" property="itemId"/>]>.value"><%=sTranCurrentGlasses_ADD%></textarea>
            </td>
        </tr>
        ...
        <%-- right : blurtest --%>
        <tr>
            <td class="admin" rowspan="2"><%=getTran(request,"openclinic.chuk","with.correction",sWebLanguage)%></td>
            <td class="admin"><%=getTran(request,"openclinic.chuk","od",sWebLanguage)%></td>
            <td class="admin2">
                <input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_BLURTEST_OD")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_BLURTEST_OD" property="itemId"/>]>.value" value="<%=sTranBlurtest_OD%>" size="8"/>&nbsp;
            </td>
            <td class="admin2">
                D <img src="<c:url value="/_img/up_down_arrow.gif"/>" alt=""/> &nbsp;<input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_BLURTEST_OD_D")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_BLURTEST_OD_D" property="itemId"/>]>.value" value="<%=sTranBlurtest_OD_D%>" size="8"/>&nbsp;
            </td>
            <td colspan="2" rowspan="2" class="admin2">
                <%=getTran(request,"web","comment",sWebLanguage)%>&nbsp;<textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" cols="80" <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_BLURTEST_ADD")%> class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_BLURTEST_ADD" property="itemId"/>]>.value"><%=sTranBlurtest_ADD%></textarea>
            </td>
        </tr>
        ...
        <%-- cornea --%>
        <tr>
            <td class="admin" rowspan="7"><%=getTran(request,"openclinic.chuk","biomicroscopy",sWebLanguage)%></td>
        ...
        <%-- lids --%>
        <tr>
            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","lids",sWebLanguage)%></td>
            <td class="admin2" colspan="4">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_LIDS")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_LIDS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_LIDS" property="value"/></textarea>
            </td>
        </tr>

        <%-- conjunctive --%>
        <tr>
            <td class="admin" colspan="2"><%=getTran(request,"web","conjunctiva",sWebLanguage)%></td>
            <td class="admin2" colspan="4">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CONJUNCTIVA")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CONJUNCTIVA" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_CONJUNCTIVA" property="value"/></textarea>
            </td>
        </tr>

        <%-- iris --%>
        <tr>
            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","iris",sWebLanguage)%></td>
            <td class="admin2" colspan="4">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_IRIS")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_IRIS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_IRIS" property="value"/></textarea>
            </td>
        </tr>

        <%-- lens --%>
        <tr>
            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","lens",sWebLanguage)%></td>
            <td class="admin2" colspan="4">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_LENS")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_LENS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_LENS" property="value"/></textarea>
            </td>
        </tr>
        ...
        <%-- treatment --%>
        <tr>
            <td class="admin" colspan="3" rowspan="1"><%=getTran(request,"openclinic.chuk","treatment",sWebLanguage)%></td>
            <td class="admin2" colspan="4">
        ...
        <%-- new.glasses ------------------------------------------------------------------------%>
        <tr>
            <td class="admin" colspan="3"><%=getTran(request,"openclinic.chuk","new.glasses",sWebLanguage)%></td>
			<td class="admin2" colspan="4">
				<table width="100%">
					<tr>
			            <td class="admin" colspan="3"><%=getTran(request,"openclinic.chuk","right.eye",sWebLanguage)%></td>
			            <td class="admin" colspan="3"><%=getTran(request,"openclinic.chuk","left.eye",sWebLanguage)%></td>
					</tr>
					<tr>
						<td class="admin2" width="16%"><%=getTran(request,"openclinic.chuk","spherical",sWebLanguage)%></td>
						<td class="admin2" width="16%"><%=getTran(request,"openclinic.chuk","cylindrical",sWebLanguage)%></td>
						<td class="admin2" width="16%"><%=getTran(request,"openclinic.chuk","axis",sWebLanguage)%></td>
						<td class="admin2" width="16%"><%=getTran(request,"openclinic.chuk","spherical",sWebLanguage)%></td>
						<td class="admin2" width="16%"><%=getTran(request,"openclinic.chuk","cylindrical",sWebLanguage)%></td>
						<td class="admin2"><%=getTran(request,"openclinic.chuk","axis",sWebLanguage)%></td>
					</tr>
				</table>
			</td>
        </tr>
        <tr>
        	<td class="admin"/>
            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","distant.vision",sWebLanguage)%></td>
			<td class="admin2" colspan="4">
				<table width="100%">
					<tr>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_SPHERICAL")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_SPHERICAL" property="itemId"/>]>.value" value="<%=sTranNewGlassesRightDistantVisionSpherical%>" size="8"/></td>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_CYLINDRICAL")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_CYLINDRICAL" property="itemId"/>]>.value" value="<%=sTranNewGlassesRightDistantVisionCylindrical%>" size="8"/></td>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_AXIS")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_DISTANT_VISION_AXIS" property="itemId"/>]>.value" value="<%=sTranNewGlassesRightDistantVisionAxis%>" size="8"/>°</td>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_SPHERICAL")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_SPHERICAL" property="itemId"/>]>.value" value="<%=sTranNewGlassesLeftDistantVisionSpherical%>" size="8"/></td>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_CYLINDRICAL")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_CYLINDRICAL" property="itemId"/>]>.value" value="<%=sTranNewGlassesLeftDistantVisionCylindrical%>" size="8"/></td>
						<td class="admin2"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_AXIS")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_DISTANT_VISION_AXIS" property="itemId"/>]>.value" value="<%=sTranNewGlassesLeftDistantVisionAxis%>" size="8"/>°</td>
					</tr>
				</table>
			</td>
        </tr>
        <tr>
        	<td class="admin"/>
            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","near.vision",sWebLanguage)%></td>
			<td class="admin2" colspan="4">
				<table width="100%">
					<tr>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_SPHERICAL")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_SPHERICAL" property="itemId"/>]>.value" value="<%=sTranNewGlassesRightNearVisionSpherical%>" size="8"/></td>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_CYLINDRICAL")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_CYLINDRICAL" property="itemId"/>]>.value" value="<%=sTranNewGlassesRightNearVisionCylindrical%>" size="8"/></td>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_AXIS")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_RIGHT_NEAR_VISION_AXIS" property="itemId"/>]>.value" value="<%=sTranNewGlassesRightNearVisionAxis%>" size="8"/>°</td>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_SPHERICAL")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_SPHERICAL" property="itemId"/>]>.value" value="<%=sTranNewGlassesLeftNearVisionSpherical%>" size="8"/></td>
						<td class="admin2" width="16%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_CYLINDRICAL")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_CYLINDRICAL" property="itemId"/>]>.value" value="<%=sTranNewGlassesLeftNearVisionCylindrical%>" size="8"/></td>
						<td class="admin2"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_AXIS")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_LEFT_NEAR_VISION_AXIS" property="itemId"/>]>.value" value="<%=sTranNewGlassesLeftNearVisionAxis%>" size="8"/>°</td>
					</tr>
				</table>
			</td>
        </tr>
        <tr>
        	<td class="admin"/>
            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","interpupillary.distance",sWebLanguage)%></td>
			<td class="admin2" colspan="4">
				<table width="100%">
					<tr>
						<td class="admin2" width="16%"><%=getTran(request,"openclinic.chuk","distant.mm",sWebLanguage)%></td>
						<td class="admin2" width="32%"><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_DISTANT_IP")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_DISTANT_IP" property="itemId"/>]>.value" value="<%=sTranNewGlassesDistantIP%>" size="8"/></td>
						<td class="admin2" width="16%"><%=getTran(request,"openclinic.chuk","near.mm",sWebLanguage)%></td>
						<td class="admin2" ><input <%=setRightClick(session,"ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_NEAR_IP")%> class="text" type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_CONSULTATION_NEW_GLASSES_NEAR_IP" property="itemId"/>]>.value" value="<%=sTranNewGlassesNearIP%>" size="8"/></td>
					</tr>
				</table>
			</td>
        </tr>
