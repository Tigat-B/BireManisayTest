        ...
        <tr>
            <td style="vertical-align:top" width="50%">                
                <table class="list" cellspacing="1" cellpadding="0" width="100%">
					...
					<tr>
						<td class="admin"><%=getTran(request,"web","treatment.observation",sWebLanguage)%>&nbsp;</td>
						<td class="admin2">
						<select name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NPOS_TREATMENT_OBSERVATION" property="itemId"/>]>.value" class="text">
						            		<option/>
						            		<%=ScreenHelper.writeSelect(request, "npos.treatment.observation", ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NPOS_TREATMENT_OBSERVATION"), sWebLanguage) %>
								</select>
        </td>
    </tr>
			        <tr>
