...
//            sBeginDate+= "&nbsp;<input type='button' name='buttonNewAPC' class='button' onclick='newAPC()' value='"+getTran(request,"Web","new",sWebLanguage)+"'>";
        ...
        SH.syslog("regions: "+vRegions.size());
        ...
        out.print(sBeginDate
              +inputRow(request,"Web","village","PAddress","AdminPrivate",apc.address,"T",true, true,sWebLanguage)
              ...
              +"<tr><td class='admin'>"+getTran(request,"web","country.town",sWebLanguage)+"</td><td class='admin2'>"+sCities+"</td></tr>"
              +inputRow(request,"Web","postcode","PZipcode","AdminPrivate",apc.zipcode,"T",false,false,sWebLanguage)
              ...
              +inputRow(request,"Web","other","PComment","AdminPrivate",apc.comment,"T",true,false,sWebLanguage));
    %>
    <%-- spacer --%>
    <tr height="0">
