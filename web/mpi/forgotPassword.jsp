...
<%=sCSSNORMAL %>
<title><%=SH.cs("mpiServerName","KHIN") %></title>
<html>
	<head>
		<%=sKHINFAVICON %>
	</head>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
			    <tr>
			        <td align="center" style="vertical-align:top;" width="1%">
			            <a href='<%=SH.cs("MPIServerURL ","https://khin.rw")%>'><img height='200px' src="<%=MedwanQuery.getInstance().getConfigString("mpiLoginLogo","https://khin.rw/khin/projects/khin/_img/logo_print.gif") %>" border="0"></a>
						<br/>&nbsp;<br/>&nbsp;<br/>&nbsp;<br/>
			        </td>
			    </tr>
					<td>
