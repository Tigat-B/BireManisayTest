	...
	<table width='100%'>
		<tr>
			<td width='50%'>
				<table>
					<tr>
						<td class='tdgrey'><%=SH.cs("mpiServerName","KHIN") %></td>
						<td>
			...
			<% 	
				if(bShowResults){
					...
					if(persons.size()==0){
						...
						out.println("<tr><td class='tdgrey' nowrap width='1%'>"+SH.cs("mpiServerName","KHIN")+":&nbsp;</td><td class='tdredbold'>"+ScreenHelper.convertToUUID(p.personid)+"</td></tr>");
						...
						while(iExtends.hasNext()){
							...
							if(key.startsWith("facilityid$")){
								...
								sIdentifiers.append("<tr><td class='smallgrey' nowrap width='1%'>"+GHBNetwork.getServerNameByDomain(key.replaceAll("facilityid\\$",""))+":&nbsp;</td><td class='smallblackbold'>"+sValue+"</td></tr>");
							}
						}
