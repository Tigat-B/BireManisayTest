...
<%=checkPermission(out,"adt.urgencybedoverview","select",activeUser)%>
                    ...
                    while(iter.hasNext()){
                        ...
                        if(((Boolean)hOccupiedInfo.get("status")).booleanValue()){
                            ...
                            <tr style="height:16px;" class="list<%=sClass%>">
                                ...
                                <td><%=getTran(request,SH.cs("encounterOrigin","urgency.origin"),encounter.getOrigin(),sWebLanguage)%></td>
                                <td><%=sProblem%></td>
                                <td>
                                <%
