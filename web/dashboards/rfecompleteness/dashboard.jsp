...
<%
	String prefix="rfecompleteness";
%>
<table width='100%'>
	<tr>
		<td style='text-align: center'>
			<%=writeDashboardText("rfecompleteness","<img height='14px' src='"+sCONTEXTPATH+"/_img/themes/default/ajax-loader.gif'/>") %><br>
		</td>
	</tr>
</table>
	...
	function <%=prefix%>getValue(){
	    ...
	    new Ajax.Request(url,{
	      	...
	      	onSuccess: function(resp){
	            ...
	            rfecompleteness.innerHTML="Couverture des motifs de contacts:<br/>"+(result.coverage*1).toFixed(2)+"%";
	      		//*****************************************
