		    ...
		    if(visits.size() > 0){
				...
				for(int i=0; i<visits.size(); i++){
                    ...
                    sOutEnc1.append("<tr class=\"list"+sClass+"\" onmouseover=\"this.className='list_select';\" onmouseout=\"this.className='list"+sClass+"';\">")
                             ...
                             .append("<td onClick=\"clickCheckBox('visitUID_"+cbCounter+"')\">&nbsp;"+getTran(request,SH.cs("encounterOrigin","urgency.origin"),encounter.getOrigin(),sWebLanguage)+"</td>")
			...
			if(admissions.size() > 0){
				...
				for(int i=0; i<admissions.size(); i++){
                    ...
                    sOutEnc2.append("<tr class=\"list"+sClass+"\" onmouseover=\"this.className='list_select';\" onmouseout=\"this.className='list"+sClass+"';\">")
                             ...
                             .append("<td onClick=\"clickCheckBox('admissionUID_"+cbCounter+"');\">&nbsp;"+getTran(request,SH.cs("encounterOrigin","urgency.origin"),encounter.getOrigin(),sWebLanguage)+"</td>")
