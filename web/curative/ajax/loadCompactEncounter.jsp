...
<%
	String encounteruid="",encounterservice="",encounterservicename="",encountertype="",encountermanager="",encountermanagername="",encounterorigin=SH.cs("defaultOrigin","1"),encountersituation=SH.cs("deafultOrigin","1");
    ...
    <td class="admin2">
     <%if(bClosedEncounter){ %>
         <select class="text" name="EditEncounterOrigin" id="EditEncounterOrigin">
             <option/>
             <%=ScreenHelper.writeSelect(request,SH.cs("encounterOrigin","urgency.origin"),encounterorigin,sWebLanguage)%>
         </select>
     <%}else{ %>
         <select class='text' id="EditEncounterOrigin" id="EditEncounterOrigin">
         	<option value='<%=encounterorigin %>'><%=getTran(request,SH.cs("encounterOrigin","urgency.origin"),encounterorigin,sWebLanguage) %></option>
         </select>
     <%} %>
    </td>
</tr>
<tr>
    ...
    <td class="admin2">
     <%if(bClosedEncounter){ %>
         <select class="text" name="EditEncounterSituation" id="EditEncounterSituation">
             <option/>
             <%=ScreenHelper.writeSelect(request,SH.cs("encounterSituation","encounter.situation"),encountersituation,sWebLanguage)%>
         </select>
     <%}else{ %>
         <select class='text' id="EditEncounterSituation" id="EditEncounterSituation">
         	<option value='<%=encountersituation %>'><%=getTran(request,SH.cs("encounterSituation","encounter.situation"),encountersituation,sWebLanguage) %></option>
         </select>
     <%} %>
    </td>
</tr>
