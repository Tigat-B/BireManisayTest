...
<%=
 (
    ...
    +(activeUser.getAccessRight("download.backup.select")?writeTblChild("main.do?Page=userprofile/downloadBackup.jsp",getTran(request,"web.userProfile","download.backup",sWebLanguage),rowIdx++):"")
