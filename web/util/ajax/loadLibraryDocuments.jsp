...
<%
	...
	for(int n=0;n<documents.size();n++){
		...
		if(document.deleteDate==null){
			out.println("<tr>");
			out.println("<td class='admin' width='1%' nowrap><img style='vertical-align: middle' height='14px' src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' onclick='deleteDocument("+document.getServerId()+","+document.getObjectId()+")'/>");
			out.println("<img style='vertical-align: middle' height='14px' src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' onclick='editDocument("+document.getObjectId()+")'/>");
			out.println("&nbsp;</td>");
