...
<%
	...
	//*** 7 - INVOICES ***************************************************
        ...
        try{
			...
			while(rs.next()){
				try{
					...
					sResult.append(ScreenHelper.getTranNoLink(SH.cs("encounterSituation","encounter.situation"),rs.getString("oc_encounter_situation"),sWebLanguage)+";");
					sResult.append(personid+";");
		...
		for(int r=0;r<records.size();r++){
			...
			sResult.append(ScreenHelper.removeAccents(getTranNoLink(SH.cs("encounterOrigin","urgency.origin"),(String)ht.get("oc_encounter_origin"),sWebLanguage)).toUpperCase()+";");
			if(enddate!=null){
			...
			sResult.append(ScreenHelper.removeAccents(getTranNoLink(SH.cs("encounterOutcomeType","encounter.outcome"),(String)ht.get("oc_encounter_outcome"),sWebLanguage)).toUpperCase()+";");
			sResult.append(ScreenHelper.removeAccents(getTranNoLink(SH.cs("encounterSituation","encounter.situation"),(String)ht.get("oc_encounter_situation"),sWebLanguage)).toUpperCase()+";");
