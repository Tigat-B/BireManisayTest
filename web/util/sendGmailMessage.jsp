...
<%
	...
	try{
		Debug.println("mail.smtp.host="+ MedwanQuery.getInstance(false).getConfigString("mailbot.server","smtp.gmail.com"));
		Debug.println("mail.smtp.port="+ MedwanQuery.getInstance(false).getConfigString("mailbot.port","587"));
		Debug.println("mail.smtp.user="+ username);
		Debug.println("mail.smtp.password="+ password);
