    ...
    <tr>
        ...
        <td class="admin2">
            <select class="text" name="EditEncounterOutcome" style="vertical-align:-2px;">
                ...
                <%=HTMLEntities.htmlentities(ScreenHelper.writeSelectUnsorted(request,SH.cs("encounterOutcomeType","encounter.outcome"), sEditEncounterOutcome, sWebLanguage))%>
            </select>
        </td>
    </tr>
...
<tr>
    ...
    <td class="admin2"><b><%=(encounter.getService()==null?"":encounter.getService().getLabel(sWebLanguage))+(encounter.getOutcome()==null?"":" ("+getTran(request,SH.cs("encounterOutcomeType","encounter.outcome"),encounter.getOutcome(),sWebLanguage)+")")%></b></td>
</tr>
                <%
            }
        }
