    ...
    <tr>
        ...
        <td class="admin2">
                <select class="text" name="EditEncounterOrigin" style="vertical-align:-2px;">
                    <option/>
                    <%
                        out.print(ScreenHelper.writeSelect(request,SH.cs("encounterOrigin","urgency.origin"),sEditEncounterOrigin,sWebLanguage));
                    %>
                </select>
        </td>
    </tr>
...
<table width="100%" class="list" border="0">
    ...
    <tr>
        ...
        <td class="admin2"><b><%=
            (encounter.getService() == null ? "" : encounter.getService().getLabel(sWebLanguage)) + (encounter.getOutcome() == null ? "" : " (" + getTran(request,SH.cs("encounterOutcomeType","encounter.outcome"), encounter.getOutcome(), sWebLanguage) + ")")%>
        </b></td>
    </tr>
    <%
            }
