	...
	for(int n=invoices.size()-1; n>=0; n--){
		...
		if(invoice!=null){
			...
			out.print("<tr class='list"+sClass+"'>");
			 ...
			 out.print("<td><a href='javascript:openinvoice(\""+invoice.getObjectId()+"\")'>"+invoice.getUid()+"</a></td>");
...
<script>  
  ...
  function closeWindow(){
	...
	function openinvoice(uid){
		openPopup('/financial/insuranceInvoiceEdit.jsp&PopupWidth=1024&PopupHeight=600&FindInsurarInvoiceUID='+uid);
	}
</script>