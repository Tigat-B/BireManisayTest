...
<form name="EditForm" id="EditForm" method="POST">
    ...
    <table class="list" border="0" width="100%" cellspacing="1">    
        ...
        <tr>
            ...
            <td class="admin2">
                <input type="text" class="text" id="code" name="code" size="30" maxLength="50" value="<%=checkString(asset.getCode())%>">
            </td>
        </tr>
        <tr>
	        <%-- GMDNCODE --%>
        ...
        <tr>
            ...
            <td class="admin"><%=getTran(request,"web","accreditationcompany",sWebLanguage)%></td>
            <td class='admin2'>
            	<select class="text" id="comment25" name="comment25">
            		<option/>
            		<%=SH.writeSelect(request, "control.company", checkString(asset.getComment25()), sWebLanguage) %>
            	</select>
            </td> 
        </tr>
        <tr>
