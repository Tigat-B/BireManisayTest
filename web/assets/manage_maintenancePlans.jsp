		...
		<form name="EditForm" id="EditForm" method="POST">
		    ...
		    <table class="list" border="0" width="100%" cellspacing="1">
		        ...
		        <tr>
		            ...
		            <td class="admin"><%=getTran(request,"web.assets","sendalertsto",sWebLanguage)%>&nbsp;</td>
		            <td class="admin2">
		                <textarea class="text" name="comment9" id="comment9" cols="40" rows="1" onKeyup="resizeTextarea(this,10);" maxlength=255"><%=plan.getComment9() %></textarea>
		            </td>
		        </tr>  
