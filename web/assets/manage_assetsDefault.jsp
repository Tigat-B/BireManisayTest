...
<%    
    ...
    if(sAction.equalsIgnoreCase("save")){
    	...
    	String sComment18 = SH.c(request.getParameter("comment18"));
    	String sComment19 = SH.c(request.getParameter("comment19"));
    	String sComment20 = SH.c(request.getParameter("comment20"));
