...
<%
    ...
    String sCode          = checkString(request.getParameter("code")),
           ...
           sComment21            = checkString(request.getParameter("comment21")),
           sComment22            = checkString(request.getParameter("comment22")),
           sComment23            = checkString(request.getParameter("comment23")),
           sComment24            = checkString(request.getParameter("comment24")),
           sComment25            = checkString(request.getParameter("comment25")),
    ...
    if(Debug.enabled){
        ...
        Debug.println("sComment21          : "+sComment21);
        Debug.println("sComment22          : "+sComment22);
        Debug.println("sComment23          : "+sComment23);
        Debug.println("sComment24          : "+sComment24);
        Debug.println("sComment25          : "+sComment25);
    ...
    */
    ...
    asset.setComment21(sComment21);
    asset.setComment22(sComment22);
    asset.setComment23(sComment23);
    asset.setComment24(sComment24);
    asset.setComment25(sComment25);
