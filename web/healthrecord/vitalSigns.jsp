...
<table width="100%">
	...
	<tr>
		<td width='1%' nowrap><b><%=getTran(request,"web","capillarglycemia",sWebLanguage)%>:</b></td>
		<td colspan='7' nowrap><%=ScreenHelper.writeDefaultTextInput(session, (TransactionVO) transaction, "ITEM_TYPE_BIOMETRY_GLYCEMIA", 5) %> g/dl</td>
	</tr>
	<tr>
