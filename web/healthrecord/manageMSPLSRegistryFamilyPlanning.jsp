...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno", "ITEM_TYPE_PVVIH", sWebLanguage, false, "", "") %>&nbsp;
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"web", "acceptantmarried", sWebLanguage)%></td>
            <td class="admin2">
        ...
        <tr>
            <td class="admin"><%=getTran(request,"web", "emergencycontraceptive", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "mspls.pf.emergency",  "ITEM_TYPE_FP_EMERGENCYCONTRACEPTIVE", sWebLanguage, true, "", " ") %>
            </td>
        </tr>
        <tr>
		...
		<tr>
            ...
            <td class="admin2">
				<%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO) transaction, "ITEM_TYPE_FP_GIVENQUANTITY", 5, 0, 1000, sWebLanguage) %>
            </td>
        </tr>	
		<tr class='admin'>
        ...
        <tr>
            ...
            <td class="admin2">
				...
				<br/> <%=getTran(request,"web", "reason", sWebLanguage)%><%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_REASONFORCHANGE", 60,1) %>
            </td>
        </tr>
        <tr>
		...
		<tr>
            <td class="admin"><%=getTran(request,"web", "sideeffectstraitement", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_FP_SIDEEFFECTSTRAITEMENT", 60,1) %>
            </td>
        </tr>
        <tr>
        	<td colspan='2'><hr/></td>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"web", "injectionsbytps", sWebLanguage)%></td>
            <td class="admin2">
            	...
            	<%=ScreenHelper.writeDefaultCheckBox((TransactionVO)transaction,request, "","ITEM_TYPE_FP_DMPASC",  sWebLanguage,"") %><%=getTran(request,"web","sayanapress",sWebLanguage) %>
            </td>
        </tr>
		<tr>
            <td class="admin"><%=getTran(request,"web", "quantity_dmpagivenbytps", sWebLanguage)%></td>
            <td class="admin2">
             <%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO) transaction, "ITEM_TYPE_FP_QUANTITY_DMPAIM", 2, 0,5, sWebLanguage) %>
            	</td>
        </tr>
		<tr>
            <td class="admin"><%=getTran(request,"web", "quantity_sayanapressgivenbytps", sWebLanguage)%></td>
            <td class="admin2">
             <%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO) transaction, "ITEM_TYPE_FP_QUANTITY_SAYANAPRESS", 2, 0, 5, sWebLanguage) %>
            	</td>
        </tr>
		<tr>
		...
		<tr>
            <td class="admin"><%=getTran(request,"web", "serologystate", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_FP_SEROLOGYSTATE", 40,1) %>
            </td>
        </tr>
        <tr>
