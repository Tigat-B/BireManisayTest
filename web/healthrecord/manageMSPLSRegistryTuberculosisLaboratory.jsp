...
<%
	String accessright="mspls.registry.tblaboratory";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	<td class='admin'><%=getTran(request,"tblab","cdsname",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultTextInput(session, (TransactionVO)transaction, "ITEM_TYPE_CDSNAME", 40)%></td>
        	<td class='admin'><%=getTran(request,"tblab","asc",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultTextInput(session, (TransactionVO)transaction, "ITEM_TYPE_ASC", 40)%></td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"web","motive",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_MOTIVE", "tblab.motive", sWebLanguage, "")%></td>
        ...
        <tr>
        	<td class='admin'><%=getTran(request,"tblab","genexpert",sWebLanguage) %></td>
        	<td class='admin2'>
        	...
        	<td class='admin'><%=getTran(request,"tblab","tvp",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultRadioButtons((TransactionVO)transaction, request, "posneg", "ITEM_TYPE_TVP", sWebLanguage, true, "", "") %></td>
        </tr>
        <tr>
