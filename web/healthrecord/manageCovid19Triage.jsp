...
<div id='divcontent' style="overflow-y: scroll;">    
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_TUBERCULOSIS", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","asplenia",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_ASPLENIA", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","hepatitis",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HEPATITIS", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","diabetes",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DIABETES", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        </tr>
        ...
        <tr>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_IMMUNODEFICIENCYNONHIV", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","hiv",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HIV", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","congenitalsyphilis",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_SYPHILIS", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","down",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_DOWN", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        </tr>
        <tr>
        	<td class='admin2topright'>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_LIVERDISEASE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","malignancy",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_MALIGNANCY", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","chronicheartfailure",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CHRONICHEARTFAILURE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","chroniclungdisease",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_CHRONICLUNGDISEASE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        </tr>
        <tr>
        	<td class='admin2topright'>
        	...
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_RENALDISEASE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","neurologicdisease",sWebLanguage) %>
        	</td>
        	<td class='admin2top'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_NEUROLOGICDISEASE", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        	<td class='admin2topright'>
        		<%=getTran(request,"covid","hypertension",sWebLanguage) %>
        	</td>
        	<td class='admin2top' colspan='3'>
        		<%=SH.writeDefaultToggle(request, (TransactionVO)transaction, "ITEM_TYPE_COVID_HYPERTENSION", "yesnounknown", sWebLanguage, "onchange='triage();'") %>
        	</td>
        </tr>
    </table>
