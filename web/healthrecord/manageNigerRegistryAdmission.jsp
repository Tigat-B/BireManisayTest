...
<!-- 
 ...
 -->
<%
	String accessright="ne.admission";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	<td class='admin'><%=getTran(request,"web","entrytype",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_ENTRYTYPE", "niger.admission.entrytype", sWebLanguage, "") %></td>
        	<td class='admin'><%=getTran(request,"web","entrydiagnosis",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_ENTRYDIAGNOSIS", 40,2) %></td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"web","treatment",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_TREATMENT", 40, 2) %></td>
