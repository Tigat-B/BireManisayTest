...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
		...
		<tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_PREGNANTWOMAN", sWebLanguage, true, "", " ") %>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="admin2">
            	...
            	<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.malariaparasites", "ITEM_TYPE_MALARIAPARASITES", sWebLanguage, true) %><br/>
				<%=getTran(request,"web","parasitedensity",sWebLanguage) %>:<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_PARASITE_DENSITY", 20,1) %>
			</td>
        </tr>
        <tr >
		...
		<tr class="admin">
            <td ><b><%=getTran(request,"web", "genexpert", sWebLanguage)%><b/></td>
			<td class="admin"></td>
        </tr>
		<tr>
            <td class="admin"><%=getTran(request,"web", "tb", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_TB","posnegna",  sWebLanguage, "") %>
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_LAB_TBTEXT", 40,1) %>
            </td>
        </tr>
		<tr>
		...
		<tr>
            <td class="admin"><%=getTran(request,"web", "rr", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_RR","posnegna",  sWebLanguage, "") %>
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_LAB_RRTEXT", 40,1) %>
            </td>
        </tr>
		<tr>
            <td class="admin"><%=getTran(request,"web", "cvvih", sWebLanguage)%></td>
            <td class="admin2">
		...
		<tr>
            <td class="admin"><%=getTran(request,"web", "cvvhb", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_CV_VHB","posnegna",  sWebLanguage, "") %>
            	<%=ScreenHelper.writeDefaultTextInput(session, (TransactionVO) transaction, "ITEM_TYPE_LAB_CVTEXT_VHB", 40) %>
            </td>
        </tr>
		<tr>
            <td class="admin"><%=getTran(request,"web", "cvvhc", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_CV_VHC","posnegna",  sWebLanguage, "") %>
            	<%=ScreenHelper.writeDefaultTextInput(session, (TransactionVO) transaction, "ITEM_TYPE_LAB_CVTEXT_VHC", 40) %>
            </td>
        </tr>
		<tr class="admin">
			<td></td>
		...
		<tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_HEPATITISB","vhb",  sWebLanguage, "") %>
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_HEPATITISC","vhc",  sWebLanguage, "") %>
		...
		<tr>
            <td class="admin"><%=getTran(request,"web", "albuminuria", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_ALBIMINURIA","albuminuria",  sWebLanguage, "") %>
			</td>
        </tr>
        <tr>
