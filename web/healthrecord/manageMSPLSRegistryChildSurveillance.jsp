    	...
    	<tr>
    		<td>
    			<table width=100%'>
			        ...
			        <tr>
			            <td class="admin"><%=getTran(request,"web", "childreferral", sWebLanguage)%></td>
			            <td class="admin2">
			            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_REFERRAL", sWebLanguage, true, "", " ") %>
			            </td>
			        </tr>
					<tr>
			            <td class="admin"><%=getTran(request,"web", "dischargereason", sWebLanguage)%></td>
			            <td class="admin2">
			            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "mspls.dischargereason", "ITEM_TYPE_DISCHARGEREASON", sWebLanguage, false,"","") %>
			            </td>
			        </tr>
				</table>
			</td>
