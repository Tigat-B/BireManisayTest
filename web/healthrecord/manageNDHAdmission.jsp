    ...
    <table class="list" width='100%' border='0' cellspacing="1">
        <tr>
                ...
                <table width="100%" cellpadding="1" cellspacing="1">
				    ...
				    <tr>
				        <td class="admin">
				            ...
				            <%=getTran(request,"web.ndh","admissiondate",sWebLanguage)%>
				        </td>
				        <td class="admin2">
				    ...
				    <tr class='admin'>
				        <td colspan="2"><%=getTran(request,"web","pastmedicalhistory",sWebLanguage)%>&nbsp;</td>
				    </tr>
				    <tr>
            ...
            <td style="vertical-align:top;" width="50%">
            	<%
            		if(tran.isNew()){
            			tran.setHealthrecordId(MedwanQuery.getInstance().getHealthRecordIdFromPersonId(Integer.parseInt(activePatient.personid)));
            			SH.updateRecentItemValue(tran, "[GENERAL.ANAMNESE]ITEM_TYPE_TEMPERATURE", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_HEARTH_FREQUENCY", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_HEARTH_RYTMH", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_BIOMETRY_WEIGHT", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_BIOMETRY_HEIGHT", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_SYSTOLIC_PRESSURE_RIGHT", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_DIASTOLIC_PRESSURE_RIGHT", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_SYSTOLIC_PRESSURE_LEFT", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_DIASTOLIC_PRESSURE_LEFT", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_RESPIRATORY_FREQUENCY", SH.getTimeDay());
            			if(tran.getItemValue("ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_RESPIRATORY_FREQUENCY").length()==0){
                			SH.updateRecentItemValue(tran, "[GENERAL.ANAMNESE]ITEM_TYPE_RESPIRATORY_FRENQUENCY","ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_RESPIRATORY_FREQUENCY", SH.getTimeDay());
            			}
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_CARDIAL_CLINICAL_EXAMINATION_RESPIRATORY_RYTHM", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "[GENERAL.ANAMNESE]ITEM_TYPE_SATURATION", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_FOETAL_HEARTRATE", SH.getTimeDay());
            			SH.updateRecentItemValue(tran, "ITEM_TYPE_ABDOMENCIRCUMFERENCE", SH.getTimeDay());
            		}
         	...
         	<td class="admin2" width='70%' style="vertical-align:top;padding:0px;">
				<table width='100%' cellpadding="0" cellspacing="0">
					...
					<tr>
			         ...
			         <tr class="admin">
			             <td colspan="2"><%=getTran(request,"web","otherinvestigations",sWebLanguage)%></td>
			         </tr>
					<tr>
					...
					<tr>
					    <td class='admin'><%=getTran(request,"web","nurseinstructions",sWebLanguage)%>&nbsp;</td>
						<td class='admin2'>
