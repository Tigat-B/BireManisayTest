...
<!-- 
 ...
 -->
<%
	String accessright="mspls.chocolaxosis";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	...
        	<td class='admin2'><%= SH.writeDefaultCheckBoxes(tran, request, "chocolaxosis.rfa", "ITEM_TYPE_REASON_FOR_ADMISSION", sWebLanguage, true) %></td>
        	<td class='admin'><%=getTran(request,"web","psychologistvisit",sWebLanguage) %></td>
        	<td class='admin2'><%= SH.writeDefaultDateInput(session, tran, "ITEM_TYPE_DATE_PSYCHOLOGIST", sWebLanguage, sCONTEXTPATH) %></td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"web","tabletsprescribed",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_PRESCRIPTION", "chocolaxosis.prescription", sWebLanguage, "") %></td>
        </tr>
    </table>
