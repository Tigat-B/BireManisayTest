...
<!-- 
 ...
 -->
<%
	String accessright="ne.familyplanning";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
		...
		<tr>
			...
			<td class='admin2'><%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_USERTYPE", "fp.usertype", sWebLanguage, "") %></td>
		</tr>
		...
		<tr>
			...
			<td class='admin2'><%=SH.writeDefaultSelect(request, tran, "ITEM_TYPE_INJECTION", "fp.injection", sWebLanguage, "") %></td>
		</tr>
		<tr>
