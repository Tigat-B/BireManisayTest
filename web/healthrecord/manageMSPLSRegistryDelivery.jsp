...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
		...
		<tr>
            <td class="admin"><%=getTran(request,"web", "distocictype", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO)transaction, "ITEM_TYPE_DISTOCIC", 60, 1) %>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="admin2">
            	<table width='100%'>
            		<tr>
            			<td width='1%' nowrap ><%=getTran(request,"mspls", "bornalive", sWebLanguage)%></td>
            			<td ><%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction,request, "yesno","ITEM_TYPE_LIVEBORN", sWebLanguage,false,"","") %></td>
            		...
            		<tr>
						<td ><%=getTran(request,"web", "sex", sWebLanguage)%></td>
            			<td ><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LIVEBORNSEX", "mspls.sex", sWebLanguage, "") %></td>
		...
		<tr>
            <td class="admin"><%=getTran(request,"mspls", "reanimation", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "mspls.reanimation",  "ITEM_TYPE_REANIMATION", sWebLanguage, true, "", " ") %>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"mspls", "indirectcomplications", sWebLanguage)%></td>
            <td class="admin2">
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.acc.ptme", "ITEM_TYPE_PTME", sWebLanguage, true) %></br>
				<%=getTran(request,"mspls", "hivresults", sWebLanguage)%><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_HIVRESULTS", "posnegna", sWebLanguage, "") %>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.acc.infections", "ITEM_TYPE_INFECTIONS", sWebLanguage, true,"","") %></br>
				<%=getTran(request,"mspls", "VHBresults", sWebLanguage)%><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_VHBRESULTS", "posnegna", sWebLanguage, "") %>
		...
		<tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultDateInput(session, (TransactionVO)transaction, "ITEM_TYPE_LAB_DELIVERYDATE", sWebLanguage, sCONTEXTPATH)%>
            </td>
        </tr>
        <tr>
		...
		<tr>
            <td class="admin"><%=getTran(request,"mspls", "uterotronic_gapta", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_GAPTA_UTEROTRONIC", sWebLanguage, true, "", " ") %>
            </td>
        </tr>
		<tr>
            <td class="admin"><%=getTran(request,"mspls", "stdpreventiononbaby", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_BABY_STDPREVENTION", sWebLanguage, true, "", " ") %>
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO)transaction, "ITEM_TYPE_BABY_STDPREVENTIONTEXT", 60, 1) %>
            </td>
        </tr>
        <tr>
