...
<%
	String accessright="mspls.adulthiv.closed";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	<td class='admin'><%=getTran(request,"web","reasonforclosure",sWebLanguage) %></td>
        	<td class='admin2' colspan='3'><%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "hiv.recordclosurereason", "ITEM_TYPE_HIV_RECORDCLOSUREREASON", sWebLanguage, false, "", "") %></td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"hiv","observations",sWebLanguage) %></td>
        	<td class='admin2' colspan='3'><%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO)transaction, "ITEM_TYPE_HIV_RECORDCLOSUREOBSERVATIONS", 80, 2) %></td>
        </tr>
    </table>
