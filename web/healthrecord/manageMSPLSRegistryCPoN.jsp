...
<tr>
    ...
    <td class="admin2">
     <%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_FC_FOLLOWUP", sWebLanguage, true, "", " ") %>
 </td>
</tr>
<tr>
...
<tr>
    <td class="admin"><%=getTran(request,"mspls", "resulthivscreening", sWebLanguage)%></td>
	<td class="admin2">
     <%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_RESULT_HIVSCREENING", "posneg", sWebLanguage, "", " ") %>
 </td>
</tr>
<tr>
    <td class="admin"><%=getTran(request,"mspls", "womanonart", sWebLanguage)%></td>
    <td class="admin2">
        <%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_WOMANONART", sWebLanguage, true, "", " ") %>
    </td>
</tr>
<tr>
    <td class="admin"><%=getTran(request,"web", "numberofbabies", sWebLanguage)%></td>
    <td class="admin2">
     <%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_NUMBEROFCHILDREN", sWebLanguage, "", 1, 5) %>
 </td>
</tr>
<tr>
...
<tr>
    <td class="admin"><%=getTran(request,"mspls", "babyfromhivwomanonart", sWebLanguage)%></td>
    <td class="admin2">
        <%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_BABYFROMWOMANONART", sWebLanguage, true, "", " ") %>
    </td>
</tr>
<tr>
    <td class="admin"><%=getTran(request,"mspls", "babyfromhivwomanafterpcr", sWebLanguage)%></td>
    <td class="admin2">
        <%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_BABYFROMWOMANONARTAFTERPCR", sWebLanguage, true, "", " ") %>
    </td>
</tr>
<tr>
...
<tr>
    <td class="admin"><%=getTran(request,"mspls", "adherestofamilyplanningforvihplus", sWebLanguage)%></td>
    <td class="admin2">
     <%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_FAMILYPLANNING_VIHPLUS", sWebLanguage, true, "", " ") %>
 </td>
</tr>
<tr>
