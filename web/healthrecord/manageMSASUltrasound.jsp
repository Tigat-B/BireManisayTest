...
<!-- 
 ...
 -->
<%
	String accessright="msas.ultrasound";
%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	...
        	<td class='admin2'><%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_GESTITY", 4, 0, 20, sWebLanguage) %></td>
        	<td class='admin'><%=getTran(request,"web","parity",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_PARITY", 4, 0, 20, sWebLanguage) %></td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"web","reason",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_REASON", 40, 1) %></td>
        	<td class='admin'><%=getTran(request,"web","result",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_RESULT", 40, 1) %></td>
        </tr>
        <tr>
        	<td class='admin'><%=getTran(request,"web","prescriber",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultTextInput(session, tran, "ITEM_TYPE_PRESCRIBER", 40) %></td>
        	<td class='admin'><%=getTran(request,"web","examinator",sWebLanguage) %></td>
        	<td class='admin2'><%=SH.writeDefaultTextInput(session, tran, "ITEM_TYPE_EXAMINATOR", 40) %></td>
        </tr>
        <tr>
