                            ...
                            <table bgcolor="white" cellspacing="1">
                                <tr>
                                    <td class="admin2" colspan="3">
            							...
            							&nbsp;<%=SH.writeDefaultCheckBox((TransactionVO)transaction, request, "medwan.common.true", "ITEM_TYPE_DELIVERY_CHILD_DEADAFTER24H", "") %>
                                        <%=getLabel(request,"openclinic.chuk", "dead.after.24h", sWebLanguage, "ITEM_TYPE_DELIVERY_CHILD_DEADAFTER24H")%>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table bgcolor="white" cellspacing="1">
                                <tr>
                                    <td class="admin2" colspan="3">
                                        ...
                                        <%=getLabel(request,"openclinic.chuk", "dead.in.24h", sWebLanguage, "cbdead24h")%>
            							&nbsp;<%=SH.writeDefaultCheckBox((TransactionVO)transaction, request, "medwan.common.true", "ITEM_TYPE_DELIVERY_CHILD_DEADAFTER24H2", "") %>
                                        <%=getLabel(request,"openclinic.chuk", "dead.after.24h", sWebLanguage, "ITEM_TYPE_DELIVERY_CHILD_DEADAFTER24H2")%>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="9" class="admin2">
