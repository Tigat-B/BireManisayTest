...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_DISCHARGETYPE_STA", "mspls.sta.newdischargetype", sWebLanguage, "") %>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"web", "staylength", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO) transaction, "ITEM_TYPE_STAYLENGTH", 5, 2, 150, sWebLanguage,"") %>
            </td>
        </tr>
		<tr>
            <td class="admin"><%=getTran(request,"web", "minimunweightdate", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultDateInput(session, (TransactionVO)transaction, "ITEM_TYPE_LAB_MINIMUMWEIGHTDATE", sWebLanguage, sCONTEXTPATH)%>
				<%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO) transaction, "ITEM_TYPE_MINIMUMWEIGHT", 5, 2, 150, sWebLanguage,"") %> kg
