...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
		...
		<!--
		<tr>
            <td class="admin"><%=getTran(request,"mspls", "admissiontype", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "mspls.ssn.newadmissiontype",  "ITEM_TYPE_ADMISSIONTYPE", sWebLanguage, true,"","") %>
            </td>
        </tr>
          -->
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "mspls.ssn.newadmissioncriteria",  "ITEM_TYPE_ADMISSIONCRITERIA", sWebLanguage, true,"","") %>
            </td>
        </tr>
		<tr>
            <td class="admin"><%=getTran(request,"web", "refered", sWebLanguage)%></td>
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO)transaction, "ITEM_TYPE_REFERED", 60, 1) %>
            </td>
        </tr>
...
<script>
  function calculateWeightOverHeight(){
	  if(document.getElementById("ITEM_TYPE_DISCHARGEWEIGHT")){
	  ...
	  if(document.getElementById("ITEM_TYPE_WEIGHT")){
