...
<form name='transactionForm' method='post'>
	<table>
		...
		<tr>
			...
			<td class='admin2'>
				<select class='text' name='vaccinationlocation' id='vaccinationlocation' onchange='if(this.value==1){document.getElementById("vaccinationlocationtext").style.visibility="visible"} else {document.getElementById("vaccinationlocationtext").value="";document.getElementById("vaccinationlocationtext").style.visibility="hidden"}'>
					<%SH.syslog(vaccinationlocation); %>
					<%=ScreenHelper.writeSelect(request,"vaccinationlocation", vaccinationlocation.split(":")[0], sWebLanguage) %>
		...
		<tr>
			...
			<td class='admin2'>
				<select class="text" name='observationselector' id='observationselector' onchange='if(this.value==4){document.getElementById("observationcomment").style.visibility="visible"} else {document.getElementById("observationcomment").value="";document.getElementById("observationcomment").style.visibility="hidden"}'>
		...
		<tr>
			...
			<td class='admin2'>
				<select class='text' name='modifier' id='modifier'>
