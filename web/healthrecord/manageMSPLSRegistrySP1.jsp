...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        -->
        <tr>
        	<td class='admin'><%= getTran(request,"sp1","poids",sWebLanguage) %></td>
        	<td class='admin2'>
        		<%= SH.writeDefaultNumericInput(session, tran, "ITEM_TYPE_WEIGHT", 5, 0, 500, sWebLanguage) %> kg
        	</td>
        	<td class='admin'><%= getTran(request,"sp1","observations",sWebLanguage) %></td>
        	<td class='admin2'>
        		<%= SH.writeDefaultTextArea(session, tran, "ITEM_TYPE_OBSERVATION", 40, 2)%>
        	</td>
        </tr>
        <tr>
        	<td class='admin'><%= getTran(request,"sp1","provenance",sWebLanguage) %></td>
        	<td class='admin2'>
        		<%= SH.writeDefaultSelect(request, tran, "ITEM_TYPE_ORIGIN", "sp1.origin", sWebLanguage, "") %>
        	</td>
        </tr>
    </table>
