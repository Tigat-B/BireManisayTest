...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
		...
		<tr>
			<td  class="admin"><%=getTran(request,"mspls", "screening_pvvih", sWebLanguage)%></td>
			<td class="admin2">
				<table width='100%'>
					<tr>
						<td width='15%'class="admin"><%=getTran(request,"mspls", "newconsultationinamonth", sWebLanguage)%></td>
						<td width='20%'>
							<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "yesno",  "ITEM_TYPE_NEWCONSULTATIONINAMONTH", sWebLanguage, true, "", " ") %>
						</td>
						<td width='15%'class="admin"><%=getTran(request,"mspls", "screening_in_month", sWebLanguage)%></td>
						<td width='40%'>
							<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_SCREENINGINAMONTH","mspls.labresult", sWebLanguage, "") %> 
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
            <td class="admin"><%=getTran(request,"mspls", "otherpathologies", sWebLanguage)%></td>
            <td class="admin2">
				<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_OTHERPATHOLOGIES", 60,2) %>
			</td>
        </tr>
        <tr>
            ...
            <td class="admin2">
				<table width='100%'>
					<tr>
						<td width='20%'><%=getTran(request,"web","stool",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_STOOL","mspls.labresult", sWebLanguage, "") %>  </td>
						<td width='20%'><%=getTran(request,"web","urine",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_URINE","mspls.labresult", sWebLanguage, "") %>  </td>
						<td width='20%'><%=getTran(request,"web","hemoglobine",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_HB","mspls.labresult", sWebLanguage, "") %>  </td>
						<td width='20%'><%=getTran(request,"web","thiksmear",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_THIKSMEAR","mspls.labresult", sWebLanguage, "") %>  </td>
						<td><br/><%=getTran(request,"web","rapidtest",sWebLanguage) %><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_RAPIDTEST","mspls.labresult", sWebLanguage, "") %>  </td>
					</tr>
					<tr>
						<td width='20%'><%=getTran(request,"web","bk",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_BK","mspls.labresult", sWebLanguage, "") %>  </td>
						<td width='20%'><%=getTran(request,"web","pregnancy",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_PREGNANCY","mspls.labresult", sWebLanguage, "") %>  </td>
						<td width='20%'><%=getTran(request,"web","hiv",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_HIV","mspls.labresult", sWebLanguage, "") %>  </td>
						<td width='20%'><%=getTran(request,"web","glycemia",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_GLYCEMIA","mspls.labresult", sWebLanguage, "") %>  </td>
						<td><%=getTran(request,"web","other",sWebLanguage) %><br/><%=ScreenHelper.writeDefaultTextInput(session, (TransactionVO)transaction, "ITEM_TYPE_LAB_OTHERTEXT", 10) %><%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_OTHER","mspls.labresult", sWebLanguage, "") %>  </td>
					</tr>
				</table>
            </td>
        </tr>
        <tr>
            ...
            <td class="admin2">
				<table width='100%'>
					<tr>
						<td width='1%' nowrap>
							<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_DIAGNOSISDHIS1","cds.morbidity.new", sWebLanguage, "") %>
						</td nowrap>
						<td>
							<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.disease.surveillancestatus", "ITEM_TYPE_MSPLS_DISEASESURVEILLANCESTATUSDHIS1", sWebLanguage, false, "","") %>
						</td>
					</tr>
					<tr>
						<td width='1%' nowrap>
							<%=ScreenHelper.writeDefaultSelect(request, (TransactionVO)transaction, "ITEM_TYPE_LAB_DIAGNOSISDHIS2","cds.morbidity.new", sWebLanguage, "") %>
						</td>
						<td nowrap>
							<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.disease.surveillancestatus", "ITEM_TYPE_MSPLS_DISEASESURVEILLANCESTATUSDHIS2", sWebLanguage, false, "","") %>
						</td>
					</tr>
				</table>
            </td>
            ...
            <td class="admin2">
				<table width='100%'>
					<tr>
						...
						<td>
							<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.disease.surveillancestatus", "ITEM_TYPE_MSPLS_DISEASESURVEILLANCESTATUS1", sWebLanguage, false, "","") %>
						</td>
					</tr>
					<tr>
						<td width='1%' nowrap><%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO)transaction, "ITEM_TYPE_LAB_DIAGNOSIS2",68,1) %></td>
						<td>
							<%=ScreenHelper.writeDefaultCheckBoxes((TransactionVO)transaction, request, "mspls.disease.surveillancestatus", "ITEM_TYPE_MSPLS_DISEASESURVEILLANCESTATUS2", sWebLanguage, false, "","") %>
						</td>
					</tr>
				</table>
            </td>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"web.occup","malaria.treatment",sWebLanguage)%>&nbsp;</td>
            <td>
				<table width='100%'>
					<tr>
    					<td class="admin2">
    	        			<%=SH.writeDefaultCheckBoxes((TransactionVO)transaction, request, "malaria.treatment", "ITEM_TYPE_MALARIA_TREATMENT", sWebLanguage, false) %>
	            		</td>
					</tr>
				</table>			            		
            </td>
        ...
        <%} %>
        <% if(activePatient.getAgeInDays()<=14){ %>
	        <tr>
	            <td class="admin"><%=getTran(request,"mspls", "death", sWebLanguage)%></td>
	            <td class="admin2">
					<%=ScreenHelper.writeDefaultRadioButtons((TransactionVO)transaction, request, "mspls.perinataldeath", "ITEM_TYPE_MSPLS_PERINATALDEATH", sWebLanguage,true,"","") %>
	            </td>
	        </tr>
        <%} %>
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultTextArea(session, (TransactionVO) transaction, "ITEM_TYPE_OBSERVATIONS", 60,1) %>
            </td>
        </tr>
        <tr>
