...
public class TransactionVO extends IObjectReference implements Serializable, IIdentifiable {
    ...
    public void store() {
    	MedwanQuery.getInstance().updateTransaction(MedwanQuery.getInstance().getPersonIdFromHealthrecordId(healthrecordId), this);
    }
    ...
    public static TransactionVO get(String serverid,String objectid){
    	return MedwanQuery.getInstance().loadTransactionNoCache(Integer.parseInt(serverid),Integer.parseInt(objectid));
    }
    
    public static Vector<TransactionVO> getTransactionsForHealthrecordId(int healthrecordid){
    	return MedwanQuery.getInstance().getTransactionsForHealthrecordId(healthrecordid);
    }
    //--- CONTAINS DATE VALUE ---------------------------------------------------------------------
    ...
    public void preload(){
        ...
        // ARCHIVE_ADMINDOCUMENT
        else if(this.getTransactionType().equalsIgnoreCase(ScreenHelper.ITEM_PREFIX+"TRANSACTION_TYPE_ARCHIVE_ADMINDOCUMENT")){
            items.add(MedwanQuery.getInstance().getItem(serverId,transactionId,ScreenHelper.ITEM_PREFIX+"ITEM_TYPE_DOC_UDI"));
            items.add(MedwanQuery.getInstance().getItem(serverId,transactionId,ScreenHelper.ITEM_PREFIX+"ITEM_TYPE_DOC_STORAGENAME"));
            items.add(MedwanQuery.getInstance().getItem(serverId,transactionId,ScreenHelper.ITEM_PREFIX+"ITEM_TYPE_DOC_TITLE"));
        }
