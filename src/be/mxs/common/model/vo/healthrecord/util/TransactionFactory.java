...
public abstract class TransactionFactory {
        ...
        while (iterator_source.hasNext()) {
            ...
            if ( itemVO_target == null  ) {
                ...
                if (itemVO_source.getValue()==null){
                    itemVO_target.setItemId(Integer.parseInt( IdentifierFactory.getInstance().getTemporaryNewIdentifier() ));
                }
                else {
    ...
    public void populateTransactionItemValues(TransactionVO targetTransactionVO, TransactionVO sourceTransactionVO) {
        if ( (sourceTransactionVO == null) || (targetTransactionVO == null) ) return;
        ...
        while (iterator_source.hasNext()) {
            itemVO_source = (ItemVO)iterator_source.next();
            itemVO_target = targetTransactionVO.getItem(itemVO_source.getType());
            if ( itemVO_target != null  ) {
                itemVO_target.setValue( itemVO_source.getValue() );
            }
        }
