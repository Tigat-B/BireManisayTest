...
import be.mxs.common.util.io.OBR;
...
public class PDFPatientInvoiceReceiptGenerator extends PDFInvoiceGenerator {
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFPatientInvoiceReceiptGenerator(User user, AdminPerson patient, String sProject, String sPrintLanguage, String proforma){
        this.user = user;
    	...
    	try{
            ...
            if(SH.ci("enableBurundi", 0)==1) {
	            ...
	            if(signature_obr.length() > 0) {
			        ...
			        cell = createValueCell("\n"+"OBR: "+ signature_obr + "\n ",100,new Double(7*scaleFactor).intValue(),Font.NORMAL);
			        cell.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
			        table2.addCell(cell);  
