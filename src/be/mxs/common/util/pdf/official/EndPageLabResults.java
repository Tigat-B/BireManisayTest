...
public class EndPageLabResults extends PdfPageEventHelper {
        ...
        try{
        	...
        	AdminPerson adminPerson = AdminPerson.get(labRequest.getPersonid()+"");
        	User user = User.get(labRequest.getUserid());
            try {
    			ad_conn.close();
    		} 
            ...
            String sFooter2=ScreenHelper.getTran(null,"labresult", "footer", user.person.language);
