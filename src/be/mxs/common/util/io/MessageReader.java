                ...
                try {
                    ...
                    } else
                    {
                    	...
                    	if(SH.ci("GDPREnabled", 0)==1) {
                    		ps = occupConnection.prepareStatement("insert into Healthrecorddata(healthRecordId,dateBegin,dateEnd,personId,serverid,version,versionserverid) values(aes_encrypt(?,'ABCD1234'),?,null,?,?,1,?)");
                    	}
                    	else {
