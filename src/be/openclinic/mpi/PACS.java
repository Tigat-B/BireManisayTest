...
public class PACS {
    ...
    public static TransactionVO getTransaction(ImagingStudySeriesComponent series,String studyuid) {
    	...
    	transaction.setTimestamp(series.getStarted()==null?new java.util.Date():series.getStarted());
    	transaction.setServerId(-1);
    	transaction.setTransactionId(-1);
    	transaction.setUpdateTime(series.getStarted()==null?new java.util.Date():series.getStarted());
