...
public class LabAnalysis {
    ...
    public static LabAnalysis getLabAnalysisByLabcode(String sLabcode,Connection oc_conn){
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try{
            ...
            if(rs.next()){
                objLabAnalysis = new LabAnalysis();
                objLabAnalysis.setLabId(rs.getInt("labID"));
                objLabAnalysis.setLabtype(HL7Server.checkString(rs.getString("labtype")));
                objLabAnalysis.setLabcode(HL7Server.checkString(rs.getString("labcode")));
                objLabAnalysis.setMonster(HL7Server.checkString(rs.getString("monster")));
                objLabAnalysis.setBiomonitoring(HL7Server.checkString(rs.getString("biomonitoring")));
                objLabAnalysis.setMedidoccode(HL7Server.checkString(rs.getString("medidoccode")));
                objLabAnalysis.setDhis2code(HL7Server.checkString(rs.getString("dhis2code")));
                objLabAnalysis.setLabcodeother(HL7Server.checkString(rs.getString("labcodeother")));
                objLabAnalysis.setLabgroup(HL7Server.checkString(rs.getString("labgroup")));
                objLabAnalysis.setComment(HL7Server.checkString(rs.getString("comment")));
                objLabAnalysis.setAlertvalue(HL7Server.checkString(rs.getString("alertvalue")));
                objLabAnalysis.setLimitvalue(HL7Server.checkString(rs.getString("limitvalue")));
                objLabAnalysis.setShorttimevalue(HL7Server.checkString(rs.getString("shorttimevalue")));
                objLabAnalysis.setUnit(HL7Server.checkString(rs.getString("unit")));
                objLabAnalysis.setUnavailable(rs.getInt("unavailable"));
                objLabAnalysis.setLimitedVisibility(rs.getInt("limitedvisibility"));
                objLabAnalysis.setEditor(HL7Server.checkString(rs.getString("editor")));
                objLabAnalysis.setEditorparameters(HL7Server.checkString(rs.getString("editorparameters")));
                objLabAnalysis.setPrestationcode(HL7Server.checkString(rs.getString("prestationcode")));
                objLabAnalysis.setProcedureUid(HL7Server.checkString(rs.getString("procedureuid")));
                objLabAnalysis.setHistorydays(rs.getInt("historydays"));
                objLabAnalysis.setHistoryvalues(rs.getInt("historyvalues"));
                objLabAnalysis.setSection(HL7Server.checkString(rs.getString("section")));
            }
            rs.close();
            ps.close();
        }catch(Exception e){
    ...
    public static LabAnalysis getLabAnalysisByMedidocCode(String sLabcode){
        PreparedStatement ps = null;
        ResultSet rs = null;

        String sSelect = " SELECT * FROM LabAnalysis WHERE medidoccode = ? and deletetime is null";
    ...
    public static String idForCode(String code,Connection oc_conn){
        String label=code;
        try{
            String sQuery="select labid from labanalysis where labcode=? and deletetime is null";
            PreparedStatement ps = oc_conn.prepareStatement(sQuery);
