...
public class Center extends OC_Object {
                ...
                if(ids.length == 2){
                    ...
                    sInsert = "INSERT INTO OC_HC_HISTORY("+
                              ...
                              ") SELECT "+
	                              ...
	                              " OC_HC_BEDS,"+ // 34
	                              " OC_HC_ACTIVE"+ // 35
	                          " FROM OC_HC where OC_HC_SERVERID = ? AND OC_HC_OBJECTID = ?";
    ...
    public static Center get(int version, boolean actual){
        ...
        try{        			
            ...
            String sSelect = "";
            if(actual){
                sSelect = "SELECT * FROM OC_HC"+
                          " WHERE OC_HC_SERVERID = ? AND OC_HC_OBJECTID = ?";
            }
            else{
                sSelect = "SELECT * FROM OC_HC_HISTORY"+
                          " WHERE OC_HC_SERVERID = ? AND OC_HC_OBJECTID = ?";
            }
    ...
    //--- DELETE ----------------------------------------------------------------------------------
    public static boolean delete(String sUID, String sVersion){
