...
public class Gmail {
	...
	public static boolean sendMessage(String user, String password,String from, String fromName, String to,String replyto,String subject, String message, String logo) {
		...
		PostMethod method = new PostMethod(SH.cs("mpi.gmailURL","http://localhost/openclinic/util/sendGmailMessage.jsp"));
		...
		try {
			System.out.println("Sending message to "+SH.cs("mpi.gmailURL","http://localhost/openclinic/util/sendGmailMessage.jsp"));
