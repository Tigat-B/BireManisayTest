        ...
        try{
            if(this.getUid()!=null && this.getUid().length() > 0){
                ...
                if(ids.length == 2){
                    ...
                    sSelect = "INSERT INTO OC_EXTRAINSURARINVOICES_HISTORY("+
			                  ...
			                  ") SELECT "+
			                    ...
			                    " OC_INSURARINVOICE_STATUS," +
			                    " OC_INSURARINVOICE_MODIFIERS" +
				              " FROM OC_EXTRAINSURARINVOICES WHERE OC_INSURARINVOICE_SERVERID = ? AND OC_INSURARINVOICE_OBJECTID = ?";
                    ps = oc_conn.prepareStatement(sSelect);
                    ps.setInt(1,Integer.parseInt(ids[0]));
                    ps.setInt(2,Integer.parseInt(ids[1]));
                    ps.executeUpdate();
            ...
            if(ids.length == 2){
               sSelect = " INSERT INTO OC_EXTRAINSURARINVOICES (" +
                ...
                if(bExistingVersion>-1) {
                    sSelect = " DELETE FROM OC_EXTRAINSURARINVOICES WHERE OC_INSURARINVOICE_SERVERID = ? AND OC_INSURARINVOICE_OBJECTID = ? and OC_INSURARINVOICE_VERSION<?";
                    ps = oc_conn.prepareStatement(sSelect);
                    ps.setInt(1,Integer.parseInt(ids[0]));
                    ps.setInt(2,Integer.parseInt(ids[1]));
