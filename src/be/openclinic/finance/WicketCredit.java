            ...
            if(sUids.length == 2){
                ...
                try{
                    ...
                    if(rs.next()){
                        ...
                        wicketOps.setCategory(ScreenHelper.checkString(rs.getString("OC_WICKET_CREDIT_CATEGORY")));
    ...
    public void store(){
        ...
        try{
            ...
            if(ids.length == 2){
                ...
                ps.setString(17,this.getCategory());
                ps.executeUpdate();
                ps.close();
    ...
    public static Vector selectWicketOperationsByWicket(String sWicketUID){
        ...
        try{
            ...
            while(rs.next()){
                ...
                wicketOp.setCategory(ScreenHelper.checkString(rs.getString("OC_WICKET_CREDIT_CATEGORY")));
