...
public class Insurar extends OC_Object {
    ...
    public void setOpenIMIS_Enabled(String s) {
    	MedwanQuery.getInstance().setConfigString("OpenIMISEnabled_"+getUid(), s);
    }
    
    public boolean isOpenIMISConfigured() {
    	return SH.cs("OpenIMISEnabled_"+getUid(), "0").equalsIgnoreCase("1");
    }
    
    public String getOpenIMIS_URL() {
    	if(this.isValidUid(this.getUid())) {
    		return SH.cs("OpenIMIS_URL_"+getUid(), SH.cs("OpenIMISBaseURL", "https://gambiatest.bluesquare.org")+SH.cs("OpenIMISFHIRContext", "/api/api_fhir_r4"));
    	}
    	return "";
    }
    
    public void setOpenIMIS_URL(String url) {
    	MedwanQuery.getInstance().setConfigString("OpenIMIS_URL_"+getUid(), url);
    }
    
    public String getOpenIMIS_UserName() {
    	if(this.isValidUid(this.getUid())) {
    		return SH.cs("OpenIMIS_UserName_"+getUid(), SH.cs("OpenIMISBaseLogin", ""));
    	}
    	return "";
    }
    
    public void setOpenIMIS_UserName(String url) {
    	MedwanQuery.getInstance().setConfigString("OpenIMIS_UserName_"+getUid(), url);
    }
    
    public String getOpenIMIS_Password() {
    	if(this.isValidUid(this.getUid())) {
    		return SH.cs("OpenIMIS_Password_"+getUid(), SH.cs("OpenIMISBasePassword", ""));
    	}
    	return "";
    }
    
    public void setOpenIMIS_Password(String url) {
    	MedwanQuery.getInstance().setConfigString("OpenIMIS_Password_"+getUid(), url);
    }
