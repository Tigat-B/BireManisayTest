...
public class Product extends OC_Object implements Comparable {
    	...
    	if(SH.c(productCode).length() >0){
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    throw new Exception("ERROR : PRODUCT "+productCode+" NOT FOUND");
                }
            }
            catch(Exception e){
                if(e.getMessage().endsWith("NOT FOUND")){
    ...
    public void store(boolean checkExistence){
        ...
        try{
            ...
            ps.setString(4,SH.c(this.getUnit()));
