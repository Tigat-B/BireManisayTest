...
public class MayeleAPI{
    ...
    public static void error(Element root,String id,String message) {
     ...
     public static boolean isValidUUID(String s) {
    	String numberString=s.toUpperCase().substring(0,s.length()-1);
        String alfabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ123456789";
        ...
        return alfabet.substring(25-value%26,26-value%26).equalsIgnoreCase(s.substring(s.length()-1));
    }
    ...
    public static String convertToUUID(int n) {
		...
		return letters + alfabet[(25-n%26)];
    }
