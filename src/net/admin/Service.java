    ...
    public static Vector getParentIds(String childId){
        ...
        try{
            ...
            if(service!=null){
                ...
                if(parentId!=null && !parentId.equalsIgnoreCase(service.code) && parentId.trim().length()>0 && !parentIds.contains(parentId)){
    ...
    public static Vector getChildIds(String parentId){
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(childId!=null && childId.trim().length()>0 && !childIds.contains(childId)){
                    childIds.add(childId);
