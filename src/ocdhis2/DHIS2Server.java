...
public class DHIS2Server
{
    ...
    public DHIS2Server(String prefix){
        super();
        this.baseURL = SH.cs(prefix+"dhis2_server_uri","");
        this.baseAPI = SH.cs(prefix+"dhis2_server_api", "");
        this.port = SH.cs(prefix+"dhis2_server_port","");
        this.userName = SH.cs(prefix+"dhis2_server_username","");
        this.userPassword = SH.cs(prefix+"dhis2_server_pwd","");
    }
